...
!function (a, b) {
    ...
    function _(a, b, c) {
        var d;
        if (void 0 === c && 1 === a.nodeType)if (d = "date-" + b.replace(Z, "-$&").toLowerCase(), c = a.getAttribute(d), "string" == typeof c) {
            try {
                c = $(c)
            } catch (e) {
            }
        ...
        data: function (a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = X.get(f), 1 === f.nodeType && !W.get(f, "hasDataAttrs"))) {
                    c = g.length;
                    while (c--)g[c] && (d = g[c].name, 0 === d.indexOf("date-") && (d = r.camelCase(d.slice(5)), _(f, d, e[d])));
